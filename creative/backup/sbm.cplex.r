...
#     s_r^(+),r=1..s
    ...
    for(i in 1:N)
    {
        ...
        cvec = c(coef_t,coef_gamma,coef_s_i,coef_s_r)
        ...
        Amat = rbind(constraint1,constraint2,constraint3,constraint4)
        
        results = Rcplex(cvec,Amat,bvec,sense = sense,control = list(trace=0))
        efficiency[i] = results$obj
